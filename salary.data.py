...
dataset = pd.read_csv(r"C:\Users\SAHAJ\Downloads\Salary_Data.csv")
...
#whan variance is more then bias then that model is called overfit model
#when variance is less and bias is more then that model is known as underfit model
#and when both are approximately same that is called bestfit model
